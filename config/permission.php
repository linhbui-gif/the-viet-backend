...
return [
    ...
    'introduce' => [
        'index' => 'List introduce',
        'create' => 'Create introduce',
        'edit' => 'Edit introduce',
        'destroy' => 'Destroy introduce',
        'active' => 'Active introduce',
    ],
    'introduce_categories' => [
        'index' => 'List introduce_categories',
        'create' => 'Create introduce_categories',
        'edit' => 'Edit introduce_categories',
        'destroy' => 'Destroy introduce_categories',
        'active' => 'Active introduce_categories',
    ],
    'blog_tags' => [
