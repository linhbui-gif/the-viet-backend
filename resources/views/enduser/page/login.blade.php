...
<<<<<<< HEAD
                        <div class="authen-page-wrapper">
                            ...
                            <form class="authen-form" action="{{ route('user.postlogin') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="form-item">
                                        <label>Số CCCD ( căn cước công dân )<span>*</span></label>
                                        <input type="text" class="@error('sothe') is-invalid @enderror w-100" name="sothe" placeholder="Nhập số căn cước công dân của bạn...">
                                        @error('sothe')
                                        <div class="alert alert-danger  mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="form-item">
                                        ...
                                        <input type="password" class="@error('password') is-invalid @enderror w-100" name="password" placeholder="Hãy nhập mật khẩu của bạn...">
                                        @error('password')
                                        <div class="alert alert-danger  mt-2">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group">
                                    <div class="form-item">
                                        <button class="btn btn-main-color w-100" type="submit">Đăng nhập</button>
                                    </div>
                                </div>
    ...
    <style>
        .authen-page .authen-page-wrapper {
            max-width: 450px;
            padding: 30px;
            margin: 0 auto;
            border-radius: 5px;
