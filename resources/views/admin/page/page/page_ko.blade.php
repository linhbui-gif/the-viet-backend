    ...
    @elseif($item->id == 22)
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label for="">Name</label>
                    <input value="{{ @$content['duthuyeen']['name'] }}" name="content_ko[duthuyeen][name]" type="text" class="form-control">
                </div>
                <div class="form-group">
                    <label for="">Description</label>
                    <input value="{{ @$content['duthuyeen']['description'] }}" name="content_ko[duthuyeen][description]" type="text" class="form-control">
                </div>
            </div>
        </div>
    @elseif($item->id == 23)
    ...
    @elseif($item->id == 27)
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    <label for="">Name</label>
                    <input value="{{ @$content['services_page']['name'] }}" name="content_ko[services_page][name]" type="text" class="form-control">
                </div>
                <div class="form-group">
                    <label for="">Description</label>
                    <input value="{{ @$content['services_page']['description'] }}" name="content_ko[services_page][description]" type="text" class="form-control">
                </div>
            </div>
        </div>
    @elseif($item->id == 28)
