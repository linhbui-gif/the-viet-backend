...
use App\Huongdan as MainModel;
use Illuminate\Support\Facades\Hash;
use Session;

class HuongdanController extends AdminController
{
    ...
    protected $formFields = [
        'general_tab' => [
            ...
            'items' => [
                ...
                [ 'label' => 'Danh mục' ,'name' => 'category_id', 'type' => 'select', 'data_source' => \App\Huongdan_categories::class, 'foreign_key' => 'category_huongdan_id' ],
