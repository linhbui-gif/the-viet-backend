    ...
    protected $formFields = [
        'general_tab' => [
            ...
            'items' => [
                ...
                [ 'label' => 'Nội dung popup đối tác' ,'name' => 'content', 'type' => 'ckeditor'],
...
//                        'banner_dt' => 'Hiển thị Banner khối du thuyền',
                        ...
                        'banner_about_dv' => 'Hiển thị giới thiệu trang  dịch vụ',
                        'banner_why_choose' => 'Hiển thị banner why choose us',
                        'banner_download' => 'Hiển thị banner download App',
                        'banner_step' => 'Banner 4 bước đăng ký',
                        'banner_program' => 'Hiển thị banner chương trình mới nhất',
                        'banner_loi_ich' => 'Hiển thị banner lợi ích tham gia',
                    ]
                ],
